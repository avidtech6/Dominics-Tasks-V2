...
Plan at app-fragments/family-chat/plan.md. Atomic step per UI surface.
...
Coverage matrix at app-fragments/family-chat/coverage-matrix.md. 5 columns. Empty = FAIL.
