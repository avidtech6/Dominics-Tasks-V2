...
Plan at app-fragments/family-setup/plan.md. Atomic step per UI surface.
...
Coverage matrix at app-fragments/family-setup/coverage-matrix.md. 5 columns. Empty = FAIL.
