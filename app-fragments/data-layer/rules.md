...
Plan at app-fragments/data-layer/plan.md. Atomic step per UI surface.
...
Coverage matrix at app-fragments/data-layer/coverage-matrix.md. 5 columns. Empty = FAIL.
