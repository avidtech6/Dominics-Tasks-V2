...
Plan at app-fragments/error-boundary/plan.md. Atomic step per UI surface.
...
Coverage matrix at app-fragments/error-boundary/coverage-matrix.md. 5 columns. Empty = FAIL.
